                    ...
                    <div class="row g-3">
                        <div class="col-sm-2">
                            ...
                            <input type="text" class="form-control" id="matricula" placeholder="Matrícula"
                                name="matricula" value="{{ $rh->matricula }}" required autocomplete="matricula" autofocus>
                        ...
                        <div class="col-sm-5">
                            ...
                            name="nome" value="{{ $rh->nome }}" required autocomplete="nome" autofocus>
                            <div class="invalid-feedback">
                                @error('nome')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-5">
                            ...
                            <input class="form-control " value="{{ $rh->email }}">
                        </div>

                        <div class="col-sm-4">
                            <label class="form-label fw-bolder">{{ __('CPF') }}</label>
                            <input class="form-control" value="{{ $rh->cpf }}" >
                        </div>

                        <div class="col-sm-4">
                            <label class="form-label fw-bolder">{{ __('RG') }}</label>
                            <input class="form-control" value="{{ $rh->rg }}">
                        </div>

                        <div class="col-sm-4">
                            <label class="form-label fw-bolder">{{ __('Telefone') }}</label>
                            <input class="form-control"value="{{ $rh->telefone }}">
                        </div>

                        <div class="col-8">
                            <label class="form-label fw-bolder">{{ __('Endereço') }}</label>
                            <input class="form-control text-capitalize" value="{{ $rh->endereco }}">
                        </div>

                        <div class="col-4">
                            <label class="form-label fw-bolder">{{ __('Complemento') }}</label>
                            <input class="form-control text-capitalize"value="{{ $rh->complemento }}">
                        </div>

                        <div class="col-3">
                            <label class="form-label fw-bolder">{{ __('Município') }}</label>
                            <input class="form-control text-capitalize"value="{{ $rh->cidades->municipio }}">
                        </div>
                        <div class="col-2">
                            <label class="form-label fw-bolder">{{ __('Data de assinatura') }}</label>
                            <input class="form-control"value="{{ $rh->data_inicio }}">
                        </div>
                        <div class="col-2">
                            <label class="form-label fw-bolder">{{ __('Validade') }}</label>
                            <input class="form-control text-capitalize" value="{{ $rh->validade }}">
                        </div>
                        <div class="col-2">
                        ...
                        <div class="col-3">
                            ...
                            <input class="form-control text-capitalize"value="{{ $rh->contrato }}">
                        </div>

                        <div class="col-6">
                            <label class="form-label fw-bolder">{{ __('Função') }}</label>
                            <input class="form-control text-capitalize" value="{{ $rh->funcao }}">
                        </div>
                        <div class="col-6">
                            <label class="form-label fw-bolder">{{ __('Setor') }}</label>
                            <input class="form-control text-uppercase" value="{{ $rh->setor }}">
                        </div>
